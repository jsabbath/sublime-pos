        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li id="elem_reportes" class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="false"><i class="fa fa-file-pdf-o"></i> Reportes <span class="caret"></span></a>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li id="elem_ajustes" class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="false"><i class="fa fa-cog"></i> Ajustes <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="false"><?php inicia_sesion_segura();
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="well">
                    ...
                    <h2>Propiedad de <a target="_blank" href="//mexico-todo.com.mx">México todo</a>.</h2>
                    <br>
                    <h2>Desarrollado y mantenido por <a target="_blank" href="//parzibyte.me">Parzibyte</a></h2>
                    <h3 class="text-center">¡Gracias por confiar en nosotros!</h3>
                </div>
            </div>
